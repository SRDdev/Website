    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16' style={{backgroundColor:"#ffff"}}>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <br/><br/>
          I am working with <b>BVIRAL</b> as an Intern & also building open source models on HuggingFace🤗 , I am currently exploring and gaining knowledge about Langchain. 
          <br></br><br></br>
