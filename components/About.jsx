    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16' style={{backgroundColor:"#ffff"}}>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <br/><br/>
          I am currently working on <b>building Open Source models on HuggingFace 🤗</b> and learning about Machine Learning in Production. Off the work, I enjoy writing technical articles and giving talks about Machine Learning. If you have any questions or need assistance, feel free to reach out to me. I am always happy to help!
          <br></br><br></br>
          Off the work, I enjoy watching movies and TV shows like Suits. If you have any questions or need assistance, feel free to reach out to me. I am always happy to help!
          <br></br>
          <br></br>
